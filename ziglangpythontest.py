...
import os 
import ctypes 
zigso= "/home/zeneto/meu-zig/libmain.so"
dllpath = os.path.normpath(os.path.join(os.path.dirname(__file__), zigso))
...
def search_colors(pic, colors):
    ...
    totallenghtcolor = (colors.shape[0] * colors.shape[1]) - 1
    ...
    totallengthcolorcb = ctypes.c_uint(totallenghtcolor)
